...
assert.match(mainWorkflow, /profiles: \{\}/);
assert.match(mainWorkflow, /relays: \{\}/);
assert.doesNotMatch(mainWorkflow, /ws:\/\/localhost:3100/);
assert.match(mainWorkflow, /~\/\.dev-anywhere/);
assert.match(mainWorkflow, /artifacts\/release-deep/);
