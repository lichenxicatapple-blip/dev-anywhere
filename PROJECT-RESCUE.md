...
- 第一版 `PROTOCOL-STATE-GOVERNANCE.md` 已创建，明确协议分层、状态 owner、LinkShell 差距、删除债务和第一阶段实施顺序。
...
- 按 `PROTOCOL-STATE-GOVERNANCE.md` 继续收紧 provider status / permission / lifecycle 分层，禁止重新引入 PTY 状态猜测主路径。
